...
export const mockBookings: Booking[] = [
  ...
  // --- Malis Restaurant (owner-managed) bookings ---
  {
    id: "b4",
    bookingReference: "RRA-K7P23",
    restaurantId: "owner-restaurant",
    restaurantName: "Malis Restaurant",
    restaurantImage: restaurant4,
    date: "2026-03-28",
    time: "7:00pm",
    guests: 2,
    status: "upcoming",
    specialRequests: "Anniversary dinner, candle on the table please",
    tableNumber: 3,
    bookingName: "Sophia Chen",
    bookingEmail: "sophia.chen@email.com",
  },
  {
    id: "b5",
    bookingReference: "RRA-T3N56",
    restaurantId: "owner-restaurant",
    restaurantName: "Malis Restaurant",
    restaurantImage: restaurant4,
    date: "2026-03-28",
    ...
    guests: 6,
    status: "upcoming",
    specialRequests: "One child seat needed",
    tableNumber: 8,
    bookingName: "David Kem",
    bookingEmail: "david.kem@email.com",
  },
  {
    id: "b6",
    bookingReference: "RRA-W2H89",
    restaurantId: "owner-restaurant",
    restaurantName: "Malis Restaurant",
    restaurantImage: restaurant4,
    date: "2026-03-29",
    ...
    status: "upcoming",
    tableNumber: 5,
    bookingName: "Emma Rith",
    bookingEmail: "emma.rith@email.com",
  },
  {
    id: "b7",
    bookingReference: "RRA-J8F12",
    restaurantId: "owner-restaurant",
    restaurantName: "Malis Restaurant",
    restaurantImage: restaurant4,
    date: "2026-03-20",
    ...
    tableNumber: 2,
    bookingName: "Nara Pich",
    bookingEmail: "nara.pich@email.com",
  },
  {
    id: "b8",
    bookingReference: "RRA-R4X67",
    restaurantId: "owner-restaurant",
    restaurantName: "Malis Restaurant",
    restaurantImage: restaurant4,
    date: "2026-03-18",
    ...
    status: "cancelled",
    tableNumber: 10,
    bookingName: "Lucas Thong",
    bookingEmail: "lucas.thong@email.com",
  },
];
